...
public class SubscribeDate {
	...
	public Map<String, Integer> today_info(SubscribeDate sdata) {
		...
		int search_year = Integer.parseInt(sdata.getYear());
	...
	// 스케줄 사용시 사용될 생성자
	public SubscribeDate(String year, String month, String date, String value, String schedule, String schedule_detail) {
	...
	// 달력만 사용시 사용될 생성자
	public SubscribeDate(String year, String month, String date, String value) {
